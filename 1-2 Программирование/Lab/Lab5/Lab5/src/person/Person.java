...
public class Person {
    ...
    private static long generateNextId() {
        long id = (long) (Math.random() * 200000);
        boolean False = true;
        while (False){
     ...
     */
    public static Person fromXml(long id, String name, Coordinates coordinates,
                                 Date creationDate, long height, LocalDateTime birthday,
                                 EyeColor eyeColor, HairColor hairColor, Location location) throws FieldException {
