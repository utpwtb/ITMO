 ...
 */
public class RemoveLowerClient extends CommandClient {
    private final NetWorkManager netWorkManager;

    /**
     * Конструктор.
     */
    public RemoveLowerClient(NetWorkManager netWorkManager) {
    ...
    public Request execute(String[] args, CommandMode mode) throws IOException {
        ...
        final byte[] serialized = netWorkManager.serializer(
                new Request("remove_lower", new String[]{args[0], null}));
        if (serialized == null) {
